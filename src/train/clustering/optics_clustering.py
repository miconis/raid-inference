...
# 2 - it computes the optics clusters using the estimated parameter
...
# 2 - Compute OPTICS clustering
print("Computing OPTICS clustering")
clustering = (OPTICS(max_eps=3.619,  # max distance between two samples to be considered as in the neighborhood of the other
                     min_samples=k,  # minimum number of points for each cluster
                     metric='minkowski',  # metric to be used when calculating distance
                     algorithm='ball_tree',  # for the nearest neighbors
...
print("Saving data")
torch.save(cluster_labels, "../dataset/AttentiveRAiDWalk_OPTICS_labels.pt")
